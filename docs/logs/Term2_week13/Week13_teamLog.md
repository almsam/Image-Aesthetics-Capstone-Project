...
2. Added and improved playwright e2e tests: Added navigation.spec with e2e tests to test user flow.
3. Fixed Admin sign out bug: A sign out bug in the admin navbar has been removed as well.
4. Session Management: Added sessions in backend to ensure user cant access admin pages and cant proceed to userdashboard without completing survey.
...
6. Added and improved CI/CD: Added testing.yml, deploy.yml, and build.yml to improve on the CI/CD pippelines we have built.
7. [Add more here]
...
| ------- | -------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------- |
| 289  | Fix Admin login error  |Hotfix Admin routing to user dashboard after login  | [Devstutya] | [Complete]    |
| 297  | Updated e2e playwright tests  | Final tests and checks done and added via PR #296. | [Devstutya] | [Complete]    |
| 279  | Sign out button in Admin pages  |All pages except admin dashboard revert the 'sign out' button back to admin login | [Devstutya] | [Complete]    |
| 295  | Master Readme  |make a readme file to satisfy the m4 criteria. | [Devstutya] | [Complete]    |
| 190  | Proper session management  |Session mgmt for users and admin  | [Devstutya] | [Complete]    |
| 191  | Admin access  |Only admin with admin token after login can access admin features  | [Devstutya] | [Complete]    |
| 193  | User access  |Users must complete the survey to access user features  | [Devstutya] | [Complete]    |
...
| 233  | Deployment   | Deployment of project in UBC server      | [Shakthi]   | [Complete]    |
| 265  | Backend testing | Optimize backend tests for automated testing         | [Shakthi]   | [Complete]    |
...
![alt text](KanbanWeek13.PNG "Title")
